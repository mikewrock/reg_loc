...
i = 0;
best_value = 100;
while( i < (planes.size()-1) && planes.size() >= 2 ){
	j = i+1; 
	while(  j < (planes.size())){
...
marker1.pose.position.x = marker_location(0,0);
marker1.pose.position.y = marker_location(0,1);
marker1.pose.position.z = marker_location(0,2);
...
marker2.action = visualization_msgs::Marker::ADD;
 ...
 marker2.points.resize(2);
     marker2.points[0].x = marker_location(0,0);
     marker2.points[0].y = marker_location(0,1);
     marker2.points[0].z = marker_location(0,2);
     marker2.points[1].x = marker_location(1,0);
     marker2.points[1].y = marker_location(1,1);
     marker2.points[1].z = marker_location(1,2);
...
marker3.action = visualization_msgs::Marker::ADD;
 ...
 marker3.points.resize(2);
     marker3.points[0].x = marker_location(0,0);
     marker3.points[0].y = marker_location(0,1);
     marker3.points[0].z = marker_location(0,2);
     marker3.points[1].x = marker_location(2,0);
     marker3.points[1].y = marker_location(2,1);
     marker3.points[1].z = marker_location(2,2);
...
vis_pub3 = nh.advertise<visualization_msgs::Marker>( "visualization_marker3", 0 , true);
